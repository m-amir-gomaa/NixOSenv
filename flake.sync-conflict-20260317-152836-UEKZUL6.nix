  ...
  outputs =
    ...
    }:
    {
      ...
      packages.x86_64-linux = {
        # default: the minimal Rust toolchain (rustc + cargo)
      ...
      nixosConfigurations.nixos = nixpkgs.lib.nixosSystem {
        ...
        modules = [
          ...
          (
            ...
            {
              nixpkgs.overlays = [
                # fenix.overlays.default adds pkgs.fenix.{complete,minimal,…} attrs
              ...
              environment.systemPackages = [
                # Full nightly Rust toolchain: rustc, cargo, clippy, rust-src,
                # rustfmt, rust-docs.
                ...
                # rust-analyzer-nightly: LSP for Rust; nightly build required for
                # proc-macro expansion on nightly rustc.
