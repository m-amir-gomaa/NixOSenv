...
| `nvim.nix`                      | Neovim: declares LSP servers and plugins via Nix, then symlinks into [nvim](https://github.com/m-amir-gomaa/nvim) — keeping Neovim config in its own repo, separate from the system config. |
