  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      general = {
        ...
        # Active border: Very dark black gradient.
        "col.active_border" = "rgba(111111ff) rgba(000000ff) 45deg";

        # Inactive border: Pure black
      ...
      # Recursive file search: fd lists all files under ~/Downloads, rofi filters
      ...
      bind = [
        ...
        "$mod SHIFT, A,     exec, ${pkgs.writeShellScriptBin "screenshot-area" ''
          ...
          ${pkgs.libnotify}/bin/notify-send -i "$SAVE_PATH" "Screenshot saved" "$SAVE_PATH"
        ''}/bin/screenshot-area"
        ...
        # Uppercase umlauts (Shift + ALT)
        "ALT SHIFT, a,    exec, wtype 'Ä'"
        "ALT SHIFT, o,    exec, wtype 'Ö'"
        "ALT SHIFT, u,    exec, wtype 'Ü'"
        # "ALT SHIFT, u,    exec, wtype 'ẞ'"
        ...
        # Double-quote via ALT + apostrophe
        "ALT, apostrophe, exec, wtype '\"'"
